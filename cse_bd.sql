...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 30 avr. 2023 à 20:40
...
(31, 0x696d672e706e67),
(32, 0x7574696c697361746575722e706e67);
...
(27, 'lqasxcs', 'sdcv b', 'https://isallak.lyceestvincent.fr', 31);
...
(9, 'Bahr', 'Lenny', 'aaa@gmail.com', '1234', 1);
...
--
ALTER TABLE `partenaire`
  MODIFY `Id_Partenaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
